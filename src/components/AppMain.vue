...
<template>
    <section class="container">
        ...
        <h2 v-show="store.moviesList.length !== 0" class="mb-4 text-white">FILMS</h2>
        ...
        <h2 v-show="store.tvSeriesList.length !== 0" class="mb-4 text-white">SERIE TV</h2>

        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
            <div class="col text-white text-center g-5">
                <ul class="p-0">
                </ul>
            </div>
        </div>
